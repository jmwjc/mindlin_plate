...
row = ndiv_q
# ─── Deflection W ─────────────────────────────────────────
@timeit to "open msh file" gmsh.open("msh/patchtest_quad4_$ndiv_w.msh")
...
# ─── Rotation Φ ───────────────────────────────────────────
@timeit to "open msh file" gmsh.open("msh/patchtest_quad4_$ndiv_φ.msh")
...
# ─── Shear ────────────────────────────────────────────────
@timeit to "open msh file" gmsh.open("msh/patchtest_quad4_$ndiv_q.msh")
