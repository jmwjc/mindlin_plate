...
sʷ = 1.5
sᵠ = 1.5
 XLSX.openxlsx("xls/square_un_$(ndiv_φ)_tri3_$(ndiv_w)_0.xlsx", mode="w") do xf
...
@timeit to "calculate ∫QQdΩ ∫∇QwdΩ" begin
    ...
    prescribe!(elements_q, :E=>E, :ν=>ν, :h=>h, :q => q)
...
# vtk_grid("./vtk/square_SS_un_$(ndiv_φ)_tri3_$(ndiv_w).vtu", points, cells;
