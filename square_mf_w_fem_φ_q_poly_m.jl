...
@timeit to "calculate ∫MMdΩ ∫MφdΩ" begin
    ...
    𝑎ᵐᵐ = ∫MMdΩ=>elements_m
    𝑎ᵐᵠ = [
        ∫∇MφdΩ=>(elements_m,elements),
        ∫MφdΓ=>(elements_m_Γ,elements_Γ),
    ]
    # 𝑓ᵠ = ∫φmdΩ=>elements
...
@timeit to "calculate ∫QwdΓ" begin
    ...
    𝑎 = ∫QwdΓ => (elements_1 ∪ elements_2 ∪ elements_3 ∪ elements_4, elements_w_1 ∪ elements_w_2 ∪ elements_w_3 ∪ elements_w_4)
...
@timeit to "calculate ∫MφdΓ" begin
    ...
    𝑎 = ∫MφdΓ => (elements_m_1 ∪ elements_m_2 ∪ elements_m_3 ∪ elements_m_4, elements_1 ∪ elements_2 ∪ elements_3 ∪ elements_4)
    𝑎ᵅ = ∫αφφdΓ => elements_1 ∪ elements_2 ∪ elements_3 ∪ elements_4
